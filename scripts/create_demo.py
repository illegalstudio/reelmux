#!/usr/bin/env python3
"""Generate local synthetic media for exercising ReelMux."""
import argparse
...
metadata.write_text(
    ";FFMETADATA1\ntitle=Night journey\ndate=2026\ngenre=Documentary\n"
    "description=A small synthetic video for trying ReelMux.\n"
    "[CHAPTER]\nTIMEBASE=1/1000\nSTART=0\nEND=6000\ntitle=Departure\n"
    "[CHAPTER]\nTIMEBASE=1/1000\nSTART=6000\nEND=12000\ntitle=Arrival\n",
    encoding="utf-8",
)
subtitle = args.directory / "English.srt"
subtitle.write_text(
    "1\n00:00:00,500 --> 00:00:04,000\nThe journey starts here.\n\n"
    "2\n00:00:05,000 --> 00:00:09,000\nAudio, video, and subtitles in the same MP4.\n",
    encoding="utf-8",
)
output = args.directory / "Night-journey.mkv"
subprocess.run([
    ...
    "-metadata:s:a:1", "language=deu", "-metadata:s:a:1", "title=German audio",
    str(output),
], check=True)
print(f"Video: {output.resolve()}\nSubtitles: {subtitle.resolve()}")
